<template>
  <div :class="{ show }">
    ...
    <div ref="target" class="right-panel bg-bg_color">
      <div class="project-configuration border-b-[1px] border-solid border-[var(--moly-border-color)]">
        <h4 class="dark:text-white">{{ t('panel.systemSet') }}</h4>
        <span class="w-[22px] h-[22px] cursor-pointer">
          <IconifyIconOffline
